...
struct Fovea
{
   ...
   inline const int     magnitude (int x, int y) const;
...
class FoveaT
{
   public:
      ...
      /* Note that the bounding box argument must be given in the coords and density */
      /* of the most recent fovea, not in image coords.  */
      ...
      /**
       * Erode and dilate algorithms
       * Note that these modify the edge saliency
       */
      void erode();
      void dilate();

      /**
       * Zeroes an edge in the edge saliencu
       */
