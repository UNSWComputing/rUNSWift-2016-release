...
class LocalisationAdapter : Adapter {
   public:
      ...
      /* Analyses the visionUpdateBundle to calculate a robotHeadingSuggestion
       * of where to get better localisation data and become "unlost".
       * Calculates relative to head (camera) coordinates, NOT body.
       */
      double getRobotHeadingSuggestion(VisionUpdateBundle visionUpdateBundle);
