...
void PerceptionThread::tick() {
   ...
   if (blackboard->config["debug.vision"].as<bool>()) {
      // Write localisation robots to vision
      // TODO: abstract this away behind a function wrapper for style' sake
      //visionAdapter.V.ballDetection.localisationRobots = localisationAdapter.getRobotsFromFilter();
      visionAdapter.tick();
   }
