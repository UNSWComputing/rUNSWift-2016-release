...
void populate_options(po::options_description &config_file_options) {
   ...
   camera_config.add_options()
      ...
      ("camera.top.exposure", po::value<int>()->default_value(50),
       "camera top exposure")
      ("camera.top.gain", po::value<int>()->default_value(250),
       "camera top gain")
      ("camera.top.whitebalance", po::value<int>()->default_value(3000),
      ...
      ("camera.bot.exposure", po::value<int>()->default_value(140),
       "camera bot exposure")
      ("camera.bot.gain", po::value<int>()->default_value(250),
       "camera bot gain")
      ("camera.bot.whitebalance", po::value<int>()->default_value(3000),
